	...
	<main>
		...
		<form action="/Csc/Write" method="POST">
			...
			<table>
				...
				<tr>
				    <th style="text-align: right; margin-right: 10px; font-weight: bold;">제목</th>
				    <td><input type="text" name="csc_title" value="${vo.csc_title}" /></td>
				</tr>
				<tr>
				    <th style="text-align: right; margin-right: 10px; font-weight: bold;">글쓴이</th>
				    <td><input type="text" name="csc_writer" /></td>
				</tr>
				<tr>
				    <th style="text-align: right; margin-right: 10px; font-weight: bold;">내용</th>
				    <td><textarea name="csc_cont" rows="5"></textarea></td>
				</tr>
				<tr>
				    <td colspan="2" style="text-align: center;">
				        <input type="submit" value="등록" onclick="showAlert()" />
				        <input type="button" value="취소" onclick="cancelFunction()" />
				    </td>
				</tr>
			</table>
		</form>
