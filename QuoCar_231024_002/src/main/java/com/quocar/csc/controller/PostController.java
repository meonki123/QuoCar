...
public class PostController {
	...
	public ModelAndView write(@ModelAttribute PostVo vo, HttpSession session) 
			throws Exception{
		// session에 저장된 userId를 csc_write로 저장
		String csc_writer = (String) session.getAttribute("userid");
		//vo에 csc_writer를 세팅
		
		vo.setCsc_writer(csc_writer);
		postService.insertPost(vo);
		 
		ModelAndView mv = new ModelAndView();
		mv.addObject("csc_writer",  csc_writer);
