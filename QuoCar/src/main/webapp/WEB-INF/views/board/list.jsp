        ...
        <tr>
         ...
         <c:forEach var="row" items="${map.list}">
            <tr>
               <td>${row.bno}</td>
               <td class="rowstyle">
                     <a style="color: black;" href="${path}/board/view.do?bno=${row.bno}&curPage=${map.boardPager.curPage}&searchOption=${map.searchOption}&keyword=${map.keyword}">${row.title} 
