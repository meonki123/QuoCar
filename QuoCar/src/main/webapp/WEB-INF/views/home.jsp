	...
	<div class="container">
		<div class="content">
			...
			<div class="news-image">
				<a
					...
					<span class="name">네이버 포스팅 : 소프트 엔진</span>
				</a>
			</div>
			...
			<div class="news-image">
				<a
					...
					<span class="name">네이버 포스팅 : 모터 메거진</span>
				</a>
			</div>
			...
			<div class="news-image">
				...
				<!-- 	<img src="/img/naver.png" alt="Car Guy" width="30" height="30"> -->
					...
					<span class="name">네이버 포스팅 : CAR GUY 카가이</span>
				</a>
			</div>		
			...
			<div class="news-image">
				<a
					...
					<span class="name">네이버 포스팅 : 오토 이슈</span>
				</a>
			</div>	
			<br>
			<br>
		...
		<div class="additional-content-container">
			<div class="additional-content" style="display: none;">
				<a
					...
					<span class="name">네이버 포스팅 : 모터매거진</span>
				</a>
			</div>	
		</div>	
		<br>
		...
		<div class="additional-content-container">
			<div class="additional-content2" style="display: none;">
				<a
					...
					<span class="name">네이버 포스팅 : 도이치 모터스</span>
				</a>
			</div>
		</div>
		<br>
		...
		<div class="additional-content-container">
			<div class="additional-content3" style="display: none;">
				<a
					...
					<span class="name">네이버 포스팅 : KG 모빌리티</span>
				</a>
			</div>
		</div>
	</div>
		<div class="content">
			...
			<div class="news-image">
				<a
					...
					class="centered-image left-image">
					<p>➡ Mercedes BENZ - E CLASS - 벤츠, 신형 E클래스 올터레인 공개</p><br> 
					<span class="naver"> 
					<!-- 	<img src="/img/naver.png" alt="Car Guy" width="30" height="30"> -->
					</span> 
					<span class="name">네이버 포스팅 : 오토 이슈 </span>
		...
		<div class="news-image">
			<a
				...
				<span class="name">네이버 포스팅 : 탑 라이더 </span>
			</a>
		</div>		
		...
		<div class="news-image">
			<a
				...
				<br> 
					...
					<span class="name">네이버 포스팅 : 더 아이오토</span>
			</a>
		</div>		
		...
		<div class="news-image">
			<a
				...
				<br> 
					...
					<span class="name">네이버 포스팅 : 카빌리프 </span>
			</a>
		</div>
			<br>
			<br>
		...
		<div class="additional-content-container">
			<div class="additional-content" style="display: none;">
				<a
					...
					<span class="name">네이버 포스팅 : 카매거진</span>
				</a>
			</div>	
		</div>
		<br>
		...
		<div class="additional-content-container">
			<div class="additional-content2" style="display: none;">
				<a
					...
					<span class="name">네이버 포스팅 : 불스원 </span>
				</a>
			</div>
		</div>
		<br>
		...
		<div class="additional-content-container">
			<div class="additional-content3" style="display: none;">
				<a
					...
					<span class="name">네이버 포스팅 : M Today </span>
				</a>
			</div>
		</div>
	</div>
...
<div class="container">	
	...
	<div class="content">
		...
		<br>
		<div class="news-image">
		  <img src="/img/mustang.png" alt="mycar" class="centered-image left-image">
			...
			<br>	
			<br>	
		<div class="video-thumbnails-container"; style="display: flex; justify-content: space-between; text-align: center; width: 100%;">
			<a href="https://www.youtube.com/watch?v=PLyTeHFBHuM" style="text-align: center; display: block;"> 
			<img src="/img/mustang1.jpg" alt="mustang" class="thumbnail-image">
				<p style="margin-top: 10px;"> 7세대 머스탱 등장! - 김한용 모카</p>
			</a>
			<a href="https://www.youtube.com/watch?v=TJJmnFzrS0A" style="text-align: center; display: block;"> 
			<img src="/img/mustang3.jpg" alt="mustang" class="thumbnail-image">
			<br>
